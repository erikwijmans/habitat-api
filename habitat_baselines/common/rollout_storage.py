...
class RolloutStorage:
    ...
    def __init__(
        ...
        self.observations["reachability"] = torch.zeros(
            num_steps + 1, num_envs, num_steps + 1, dtype=torch.long
        )
    ...
    def after_update(self):
        ...
        self.observations["reachability"].zero_()
    ...
    def recurrent_generator(self, advantages, num_mini_batch):
        ...
        for start_ind in range(0, num_processes, num_envs_per_batch):
            ...
            # States is just a (num_recurrent_layers, N, ...) tensor
